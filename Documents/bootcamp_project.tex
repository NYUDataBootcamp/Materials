...
Final Project               & Jupyter notebook      & Group       & 90 \\
\bottomrule
\end{tabular}
\end{center}
...
NYU Classes by the due date listed on the course website.
%The subject line should be:  ``bootcamp project ug'' or ``bootcamp project mba'' depending on the section you are in.
