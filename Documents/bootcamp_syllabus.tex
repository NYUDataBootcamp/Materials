...
% TODO: We need to change this link once gitbook is re-enabled
\vspace{-0.15in}
\begin{center}
...
The links are
% TODO: we need to update these links once we decide where our forum will go
\vspace{-0.1in}
\begin{center}
...
% TODO: we need to fix the email address below once we finish setting up the domain
